...
describe('Users Routes', () => {
    ...
    describe(`"GET:${getUsersPath}"`, () => {
        ...
        it(`should return a JSON object with all the users and a status code of "${OK}" if the
            ...
            const users = [
                new User('Sean Maxwell', 5, 'sean.maxwell@gmail.com'),
                new User('John Smith', 10, 'john.smith@gmail.com'),
                new User('Gordan Freeman', 20, 'gordan.freeman@gmail.com'),
            ];
            ...
            agent.get(getUsersPath)
                .end((err: Error, res: Response) => {
                    ...
                    const retUsers = res.body.users.map((user: Api.IUser) => {
    ...
    describe(`"POST:${addUsersPath}"`, () => {
        ...
        const userData = {
            user: new User('Gordan Freeman', 2, 'gordan.freeman@gmail.com'),
        };
    ...
    describe(`"PUT:${updateUserPath}"`, () => {
        ...
        const userData = {
            user: new User('Gordan Freeman', 10, 'gordan.freeman@gmail.com'),
        };
